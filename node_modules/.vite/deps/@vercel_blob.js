...
var require_get_context = __commonJS({
  "node_modules/@vercel/oidc/dist/get-context.js"(exports, module) {
    ...
    function getContext2() {
      ...
      return ((_b3 = (_a3 = fromSymbol[SYMBOL_FOR_REQ_CONTEXT]) == null ? void 0 : _a3.get) == null ? void 0 : _b3.call(_a3)) ?? {};
    }
  }
});
...
async function decryptKeyManagement(alg, key, encryptedKey, joseHeader, options) {
  ...
  key = await ((_b3 = (_a3 = normalize_key_default).normalizePrivateKey) == null ? void 0 : _b3.call(_a3, key, alg)) || key;
  switch (alg) {
    case "dir": {
...
async function encryptKeyManagement(alg, enc, key, providedCek, providedParameters = {}) {
  ...
  key = await ((_b3 = (_a3 = normalize_key_default).normalizePublicKey) == null ? void 0 : _b3.call(_a3, key, alg)) || key;
  switch (alg) {
    case "dir": {
      cek = key;
      break;
    ...
    GeneralEncrypt = class {
      ...
      async encrypt() {
        ...
        for (let i = 0; i < this._recipients.length; i++) {
          ...
          const { encryptedKey, parameters } = await encrypt_key_management_default(((_a3 = recipient.unprotectedHeader) == null ? void 0 : _a3.alg) || ((_b3 = this._protectedHeader) == null ? void 0 : _b3.alg) || ((_c = this._unprotectedHeader) == null ? void 0 : _c.alg), enc, recipient.key, cek, { p2c });
...
function createRemoteJWKSet(url, options) {
  ...
  Object.defineProperties(remoteJWKSet, {
    ...
    jwks: {
      value: () => {
        var _a3;
        return (_a3 = set._local) == null ? void 0 : _a3.jwks();
      },
      enumerable: true,
      configurable: false,
      writable: false
...
var USER_AGENT, _a, _b, jwksCache, RemoteJWKSet, experimental_jwksCache;
...
async function resolveBlobAuth(options) {
  ...
  if (oidcToken) {
    const manualStoreId = (_b22 = options == null ? void 0 : options.storeId) == null ? void 0 : _b22.trim();
    if (manualStoreId) {
      return {
        kind: "oidc",
        token: oidcToken,
...
var _b2;
try {
  if (((_a2 = process.env.DEBUG) == null ? void 0 : _a2.includes("blob")) || ((_b2 = process.env.NEXT_PUBLIC_DEBUG) == null ? void 0 : _b2.includes("blob"))) {
    debugIsActive = true;
  }
} catch {
}
...
var _a22;
var DOMException2 = (_a22 = globalThis.DOMException) != null ? _a22 : (() => {
  try {
    atob("~");
  } catch (err) {
...
async function getBlobError(response) {
  ...
  try {
    ...
    code = (_b22 = (_a3 = data.error) == null ? void 0 : _a3.code) != null ? _b22 : "unknown_error";
...
async function uploadPart({
  ...
  if ((_a3 = options.abortSignal) == null ? void 0 : _a3.aborted) {
    ...
    (_b22 = options.abortSignal) == null ? void 0 : _b22.addEventListener("abort", handleAbort);
  }
...
async function presign(signedToken, options) {
  ...
  if (options.operation === "head" && !((_b22 = scope.operations) == null ? void 0 : _b22.includes("head"))) {
    throw new BlobError(
